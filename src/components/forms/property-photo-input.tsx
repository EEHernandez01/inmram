...
export function PropertyPhotoInput({ existingPhotos = [], inputRef }: { existingPhotos?: ExistingPhoto[]; inputRef?: RefObject<HTMLInputElement | null> }) {
