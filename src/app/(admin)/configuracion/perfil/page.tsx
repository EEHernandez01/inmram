    ...
    <>
      ...
      <div className="mt-7 grid gap-6 xl:grid-cols-[minmax(0,1fr)_340px] xl:items-start">
        <div className="space-y-6">
          ...
          <section className="rounded-3xl bg-bg p-6 shadow-[8px_8px_18px_#c6cdd6,-8px_-8px_18px_#fff] sm:p-8">
            <div className="border-b border-brand/10 pb-6">
              <p className="text-[10px] font-bold uppercase tracking-[.13em] text-brand/70">Seguridad de la cuenta</p>
              <h2 className="mt-2 font-serif text-2xl font-semibold text-ink">Cambiar contraseña</h2>
              <p className="mt-2 text-sm leading-6 text-ink-secondary">Usa una contraseña nueva y confirma la actual para mantener el acceso a tu perfil protegido.</p>
            </div>
            <div className="pt-7">
              <ChangePasswordForm />
            </div>
